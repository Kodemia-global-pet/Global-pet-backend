...
const updatePetRecords  = (id, recordID) => {
    const pet = Pet.findByIdAndUpdate(id, { $addToSet: { records : recordID  } }, { returnDocument: "after" })
    return pet;
}
...
module.exports = { createPet, getPet, updatePet, deletePet, updatePetRecords, getRecordsbyPetID }